...
## The 140 lines and where each came from
...
### `model` and `synthetic` — written for this trainer (3 + 103)
...
A further 44 (ids `gc-…` for the Colle, `gh-…` for the Hippopotamus) were generated by
`tools/gen-gap-lines.mjs` from the next 50 rows of the coverage count (`research/W6-content-batch.md` §10).
...
is in the band, or after six moves of its own, and its plan says which. Six of the 50 rows were not built.
